...
public class EquipamentoServiceValidacaoCompleta implements EquipamentoService {
    ...
    public EquipamentoServiceValidacaoCompleta(EquipamentoRepository equipamentoRepository, FornecedorRepository fornecedorRepository, LogAuditoriaRepository logAuditoriaRepository) {
